<?php
/**
 * Caines Lab 5 functions and definitions
 *
...
if ( ! function_exists( 'lee_lab_5_setup' ) ) :
	...
	function lee_lab_5_setup() {
		 ...
		 * If you're building a theme based on Caines Lab 5, use a find and replace
		 * to change 'lee-lab-5' to the name of your theme in all the template files.
		 */
		load_theme_textdomain( 'lee-lab-5', get_template_directory() . '/languages' );
		...
		register_nav_menus( array(
			'menu-1' => esc_html__( 'Header', 'lee-lab-5' ),
            'menu-2' => esc_html__('Footer', 'lee-lab-5'),
        ) );
...
function lee_lab_5_resource_hints( $urls, $relation_type ) {
    if ( wp_style_is( 'lee-lab-5-fonts', 'queue' ) && 'preconnect' === $relation_type ) {
        $urls[] = array(
...
function lee_lab_5_scripts() {
    ...
    wp_enqueue_style('lee-lab-5-fonts', lee_lab_5_fonts_url());
    ...
    wp_localize_script('lee-lab-5-navigation', 'leelab5ScreenReaderText', array(
        'expand' => __( 'Expand Child Menu', 'lee-lab-5'),
        'collapse' => __( 'Collapse Child Menu', 'lee-lab-5'),
    ));

    wp_enqueue_script( 'lee-lab-5-functions', get_template_directory_uri() . '/js/functions.js', array('jquery'), '20190129', true );

    wp_enqueue_script( 'lee-lab-5-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
